...
import classfile.classconstant.ConstantStringInfo;

import java.util.NoSuchElementException;

/**
 * @author koi
 * @date 2023/8/19 13:31
 */
/*
运行时常量池，注意和字节码中的常量池做区分，这里指的是线程共享区的常量
将class文件中的常量池转换成为运行时常量池
这里对两种常量池做了区分，class文件中的常量池仍然用ConstantPool
而运行时常量池使用的是RuntimeConstantPool
核心在于将符号引用转为直接引用
